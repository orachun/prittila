            ...
            <div class="register-form">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="email" type="email" class="form-control" id="input-email" placeholder="อีเมล์">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-pass" class="col-sm-3 control-label">รหัสผ่าน</label>
                        <div class="col-sm-9">
                            <input name="pass" type="password" class="form-control" id="input-pass" placeholder="รหัสผ่าน">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="fullname" type="text" class="form-control" id="input-fullname" placeholder="ชื่อ-นามสกุล">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name="addr" type="text" class="form-control" id="input-addr" placeholder="ที่อยู่ในการจัดส่งสินค้า"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="tel" type="text" class="form-control" id="input-tel" placeholder="โทรศัพท์">
                        </div>
                    </div>
                    <div class="form-group">
